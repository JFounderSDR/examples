...
#if !defined __U1_ZYNQ7035_INCLUDED__
#define __U1_ZYNQ7035_INCLUDED__
...
public:
	...
	*/
	 ...
	 *
	 * 			The deallocateCapacity operation shall set the usageState attribute
	 * 			to IDLE when,after adjusting capacities, none of the device's
	 * 			capacities are still being used.
	 *
...
#endif // !defined(U1_Zynq7035_servant_INCLUDED_)

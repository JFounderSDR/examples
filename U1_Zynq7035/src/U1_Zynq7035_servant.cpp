...
{
	DEBUG(7, U1_Zynq7035_servant, " In default contructor.")
}
...
:Resource_impl(id)
{
	...
	DEBUG(3, U1_Zynq7035_servant, "In constructor with label is: " << m_label)
	DEBUG(3, U1_Zynq7035_servant, "In constructor with softwareProfile is: "
		<< m_softwareProfile)
	...
	DEBUG(7, U1_Zynq7035_servant, "In constructor with three input parameters")
	DEBUG(7, U1_Zynq7035_servant, "In constructor with id: " << id)
	DEBUG(7, U1_Zynq7035_servant, "In constructor with lbl: " << lbl)
	DEBUG(7, U1_Zynq7035_servant, "In constructor with sftwfrl: " << sftwfrl)
}
 ...
 */
CF::Device::AdminType
U1_Zynq7035_servant::adminState()
throw (
...
throw (
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::adminState], " In adminState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 */
void 
U1_Zynq7035_servant::releaseObject() 
throw (
	CF::LifeCycle::ReleaseError, 
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::releaseObject], "In releaseObject.")
	...
	try {
		...
		DEBUG(0, [U1_Zynq7035_servant::releaseObject],
...
U1_Zynq7035_servant::compositeDevice() 
throw (
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::compositeDevice], "In compositeDevice.")
 ...
 * 			device's adminState is UNLOCKED, device's operationalState is ENABLED,
 * 			and device's usageState is not BUSY.
 *
 * 			The allocateCapacity operation shall set the Device's usageState
 ...
 *			  exception, when the Device's adminState is not UNLOCKED or
 ...
 */
CORBA::Boolean 
U1_Zynq7035_servant::allocateCapacity(
...
throw (
	...
	CORBA::SystemException)
{	
	DEBUG(5, [U1_Zynq7035_servant::allocateCapacity], "In allocateCapacity.")
 ...
 * 			to ACTIVE when,after adjusting capacities, any of the device's
 * 			capacities are still being used.
 *
 * 			The deallocateCapacity operation shall set the usageState attribute
 * 			to IDLE when,after adjusting capacities, none of the device's capacities
 ...
 * 			  	exception, when the device's adminState is LOCKED or operationalState
 * 			  	is DISABLED.
 */
void 
U1_Zynq7035_servant::deallocateCapacity(
	const CF::Properties & capacities)
throw (
	CF::Device::InvalidState, 
	CF::Device::InvalidCapacity, 
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::deallocateCapacity], " In deallocateCapacity.")
	if ((adminState()!=CF::Device::UNLOCKED) ||
		(operationalState()==CF::Device::DISABLED))
		throw CF::Device::InvalidState();
...
throw (
	...
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::configure], " In configure.")
 ...
 */
void 
U1_Zynq7035_servant::initialize()
throw (
	CF::LifeCycle::InitializeError, 
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::initialize], " In initialize.")
 ...
 */
char * 
U1_Zynq7035_servant::label() 
throw (
	CORBA::SystemException)
{
	DEBUG(9, [U1_Zynq7035_servant::label], " In label.")
...
U1_Zynq7035_servant::operationalState()
throw (
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::operationalState], " In operationalState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 * 			element's kindtype attribute is "configure" whose mode attribute is
 * 			"readwrite" or "readonly" and any allocation properties with an action
 * 			value of "external" as referenced in the component's SPD.
 *
 ...
 */
void 
U1_Zynq7035_servant::query(
	CF::Properties & props)
throw (
	CF::UnknownProperties,
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::query], " In query.")
...
throw (
	...
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::runTest], "In runTest.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
 ...
 * 			element (Profile Descriptor) with a file reference to the device's
 * 			SPD file. Files referenced within the profile are obtained via
 * 			FileManager.
 *
 * @return	device's SPD file relative to file mount point.
 */
char *
U1_Zynq7035_servant::softwareProfile() 
throw (
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::softwareProfile], " In softwareProfile.")
 ...
 */
void 
U1_Zynq7035_servant::start() 
throw (
	CF::Resource::StartError, 
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::start], "In start.")
 ...
 */
void 
U1_Zynq7035_servant::stop() 
throw (
	CF::Resource::StopError, 
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::stop], " In stop.")
 ...
 * 		  	The readonly usageState attribute shall contain the device's usage
 ...
 */
CF::Device::UsageType 
U1_Zynq7035_servant::usageState() 
throw (
	CORBA::SystemException)
{
	DEBUG(9, [U1_Zynq7035_servant::usageState], " In usageState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 */
CORBA::Object_ptr 
U1_Zynq7035_servant::getPort(
	const char * portName)
throw (
	CORBA::SystemException, 
	CF::PortSupplier::UnknownPort)
{
    DEBUG(6, [U1_Zynq7035_servant::getPort], "In getPort.")
...
{
#ifdef __SDS_OS_VXWORKS__
	DEBUG(5, [U1_Zynq7035_servant::load], "In load.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
...
{
#ifdef __SDS_OS_VXWORKS__
	DEBUG(5, [U1_Zynq7035_servant::unload], "In unload.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
 ...
 * 							operating system's process/thread stack size and
...
throw (
	...
	CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::execute], " In execute.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
...
CF::ExecutableDevice::ProcessID_Type
U1_Zynq7035_servant::executeOnVxworks(
		const char * name,
		const CF::Properties & options,
		const CF::Properties & parameters)
throw (
...
CF::ExecutableDevice::ProcessID_Type
U1_Zynq7035_servant::executeOnLinux(
		const char * name,
		const CF::Properties & options,
		const CF::Properties & parameters)
throw (
...
/**************************OPENSCA-USERREGION-BEGIN*******************************/
	...
	if (name == NULL) {
		DEBUG(0, [U1_Zynq7035_servant::executeOnLinux],
	...
	DEBUG(7, [U1_Zynq7035_servant::executeOnLinux],
	...
	DEBUG(7, [U1_Zynq7035_servant::executeOnLinux], "leaving ...")
...
void
U1_Zynq7035_servant::parseOptions(
	const CF::Properties & options,
	...
	for (int i = 0; i < options.length(); i++) {
		...
		if (strcmp(propertyId.in(), "STACK_SIZE_ID") == 0) {
			if (options[i].value >>= stacksize) {
				DEBUG(7, [U1_Zynq7035_servant::parseOptions],
...
char**
U1_Zynq7035_servant::parseExecuteParams(
	int argc,
	const CF::Properties & parameters,
 ...
 *            	if upon entry the device's adminState attribute is LOCKED or
...
throw (
    ...
    CORBA::SystemException)
{
	DEBUG(5, [U1_Zynq7035_servant::terminate], " In terminate.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
...
/**
 * @brief	This funtion used to set device's usage state.
 *
 * @param[in]	newUsageState	new usage state the device will be.
 */
void 
U1_Zynq7035_servant::setUsageState(
	CF::Device::UsageType newUsageState)
{
	DEBUG(5, [U1_Zynq7035_servant::setUsageState], " In setUsageState.")
	pthread_mutex_lock(&m_stateMtx);
...
/**
 * @brief	This function used to set device's operational state.
 *
 * @param[in]	newOperationalState	new operational state the device will be.
 */
void 
U1_Zynq7035_servant::setOperationalState(
	CF::Device::OperationalType newOperationalState)
{
	DEBUG(5, [U1_Zynq7035_servant::setOperationalState],

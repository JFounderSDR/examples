...
#include "../include/Zynq7035_PS_servant.h"

Zynq7035_PS_servant::Zynq7035_PS_servant()
{
	DEBUG(7, Zynq7035_PS_servant, " In default contructor.")
}
...
:Resource_impl(id)
{
	...
	DEBUG(3, Zynq7035_PS_servant, "In constructor with label is: " << m_label)
	DEBUG(3, Zynq7035_PS_servant, "In constructor with softwareProfile is: "
		<< m_softwareProfile)
	...
	DEBUG(7, Zynq7035_PS_servant, "In constructor with three input parameters")
	DEBUG(7, Zynq7035_PS_servant, "In constructor with id: " << id)
	DEBUG(7, Zynq7035_PS_servant, "In constructor with lbl: " << lbl)
	DEBUG(7, Zynq7035_PS_servant, "In constructor with sftwfrl: " << sftwfrl)
}
 ...
 */
CF::Device::AdminType
Zynq7035_PS_servant::adminState()
throw (
...
throw (
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::adminState], " In adminState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 */
void 
Zynq7035_PS_servant::releaseObject() 
throw (
	CF::LifeCycle::ReleaseError, 
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::releaseObject], "In releaseObject.")
	...
	try {
		...
		DEBUG(0, [Zynq7035_PS_servant::releaseObject],
...
Zynq7035_PS_servant::compositeDevice() 
throw (
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::compositeDevice], "In compositeDevice.")
 ...
 */
CORBA::Boolean 
Zynq7035_PS_servant::allocateCapacity(
...
throw (
	...
	CORBA::SystemException)
{	
	DEBUG(5, [Zynq7035_PS_servant::allocateCapacity], "In allocateCapacity.")
 ...
 */
void 
Zynq7035_PS_servant::deallocateCapacity(
	const CF::Properties & capacities)
throw (
	CF::Device::InvalidState, 
	CF::Device::InvalidCapacity, 
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::deallocateCapacity], " In deallocateCapacity.")
...
throw (
	...
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::configure], " In configure.")
	...
	try {
		...
		DEBUG(0, [Zynq7035_PS_servant::configure],
 ...
 */
void 
Zynq7035_PS_servant::initialize()
throw (
	CF::LifeCycle::InitializeError, 
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::initialize], " In initialize.")
 ...
 */
char * 
Zynq7035_PS_servant::label() 
throw (
	CORBA::SystemException)
{
	DEBUG(9, [Zynq7035_PS_servant::label], " In label.")
...
Zynq7035_PS_servant::operationalState()
throw (
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::operationalState], " In operationalState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 */
void 
Zynq7035_PS_servant::query(
	CF::Properties & props)
throw (
	CF::UnknownProperties,
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::query], " In query.")
...
throw (
	...
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::runTest], "In runTest.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
 ...
 */
char *
Zynq7035_PS_servant::softwareProfile() 
throw (
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::softwareProfile], " In softwareProfile.")
 ...
 */
void 
Zynq7035_PS_servant::start() 
throw (
	CF::Resource::StartError, 
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::start], "In start.")
 ...
 */
void 
Zynq7035_PS_servant::stop() 
throw (
	CF::Resource::StopError, 
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::stop], " In stop.")
 ...
 */
CF::Device::UsageType 
Zynq7035_PS_servant::usageState() 
throw (
	CORBA::SystemException)
{
	DEBUG(9, [Zynq7035_PS_servant::usageState], " In usageState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 */
CORBA::Object_ptr 
Zynq7035_PS_servant::getPort(
	const char * portName)
throw (
	CORBA::SystemException, 
	CF::PortSupplier::UnknownPort)
{
    DEBUG(6, [Zynq7035_PS_servant::getPort], "In getPort.")
...
{
#ifdef __SDS_OS_VXWORKS__
	DEBUG(5, [Zynq7035_PS_servant::load], "In load.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
...
{
#ifdef __SDS_OS_VXWORKS__
	DEBUG(5, [Zynq7035_PS_servant::unload], "In unload.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
...
throw (
	...
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::execute], " In execute.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
...
CF::ExecutableDevice::ProcessID_Type
Zynq7035_PS_servant::executeOnVxworks(
		const char * name,
		const CF::Properties & options,
		const CF::Properties & parameters)
throw (
...
CF::ExecutableDevice::ProcessID_Type
Zynq7035_PS_servant::executeOnLinux(
		const char * name,
		const CF::Properties & options,
		const CF::Properties & parameters)
throw (
...
/**************************OPENSCA-USERREGION-BEGIN*******************************/
	CF::ExecutableDevice::ProcessID_Type _pcRetVal =
	...
	if (name == NULL) {
		DEBUG(0, [Zynq7035_PS_servant::executeOnLinux],
	...
	if (m_adminState != CF::Device::UNLOCKED ) {
		DEBUG(0, [Zynq7035_PS_servant::executeOnLinux],
				"the state of device is locked:" << m_adminState)
		throw CF::Device::InvalidState();
	}
	...
	DEBUG(7, [Zynq7035_PS_servant::executeOnLinux],
	...
	_pcRetVal = (CF::ExecutableDevice::ProcessID_Type)pid;
	...
	DEBUG(7, [Zynq7035_PS_servant::executeOnLinux], "leaving ...")
...
void
Zynq7035_PS_servant::parseOptions(
	const CF::Properties & options,
	...
	for (int i = 0; i < options.length(); i++) {
		...
		if (strcmp(propertyId.in(), "STACK_SIZE_ID") == 0) {
			if (options[i].value >>= stacksize) {
				DEBUG(7, [Zynq7035_PS_servant::parseOptions],
...
char**
Zynq7035_PS_servant::parseExecuteParams(
	int argc,
	const CF::Properties & parameters,
	...
	CF::Properties & invalidProperties)
{
	...
	DEBUG(7, [Zynq7035_PS_servant::Zynq7035_PS_servant],
		" argc:" << argc)
...
throw (
    ...
    CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PS_servant::terminate], " In terminate.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
 ...
 */
void 
Zynq7035_PS_servant::setUsageState(
	CF::Device::UsageType newUsageState)
{
	DEBUG(5, [Zynq7035_PS_servant::setUsageState], " In setUsageState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 */
void 
Zynq7035_PS_servant::setOperationalState(
	CF::Device::OperationalType newOperationalState)
{
	DEBUG(5, [Zynq7035_PS_servant::setOperationalState],

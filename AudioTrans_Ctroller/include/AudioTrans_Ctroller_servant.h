/***************************************************************************//**
* @file     AudioTrans_Ctroller_servant.h
* @author   open Team
* @version  1
* @date     2019-05-05
* @brief
...
#if !defined __AUDIOTRANS_CTROLLER_INCLUDED__
#define __AUDIOTRANS_CTROLLER_INCLUDED__
...
#define AUDIO_CODEC_COMP_UPORT  ("AudioCodeCComp/user_data_out")
#define AUDIO_CODEC_COMP_PPORT  ("AudioCodeCComp/user_data_in")
...
#define AUDIO_CODEC_COMP_ID		("DCE:bc4b261b-fba3-4bce-bd7a-0b960c4b10a7:1")
#define AUDIOTRANS_CTROLLER_ID	("DCE:de0c9923-25cb-4bd3-be6e-cc38c4c84c11:1")

class AudioTrans_Ctroller_servant: 
...
public:
	...
	virtual ~AudioTrans_Ctroller_servant();
	
#ifdef __SDS_OS_VXWORKS__	
	AudioTrans_Ctroller_servant(
		const char * _id, 

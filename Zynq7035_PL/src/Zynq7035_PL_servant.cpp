...
#include "../include/Zynq7035_PL_servant.h"

Zynq7035_PL_servant::Zynq7035_PL_servant()
{
	DEBUG(7, Zynq7035_PL_servant, "In default contructor.")
}
...
:Resource_impl(id)
{
	DEBUG(7, Zynq7035_PL_servant, "In constructor with three input parameters")

	m_label = lbl;
	m_softwareProfile = sftwfrl;
	m_nodeName = nodeName;
	
	DEBUG(3, Zynq7035_PL_servant, "In constructor with label is: " << m_label)
	DEBUG(3, Zynq7035_PL_servant, "In constructor with softwareProfile is: "
		<< m_softwareProfile)
	...
	DEBUG(7, Zynq7035_PL_servant, "In constructor with three input parameters")
	DEBUG(7, Zynq7035_PL_servant, "In constructor with id: " << id)
	DEBUG(7, Zynq7035_PL_servant, "In constructor with lbl: " << lbl)
	DEBUG(7, Zynq7035_PL_servant, "In constructor with sftwfrl: " << sftwfrl)
}
 ...
 */
CF::Device::AdminType 
Zynq7035_PL_servant::adminState()
throw (
...
throw (
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::adminState], " In adminState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 */
void 
Zynq7035_PL_servant::releaseObject() 
throw (
	CF::LifeCycle::ReleaseError, 
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::releaseObject], " In releaseObject.")
	...
	try {
		...
		DEBUG(0, [Zynq7035_PL_servant::releaseObject], 
...
Zynq7035_PL_servant::compositeDevice() 
throw (
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::compositeDevice], "In compositeDevice.")
 ...
 */
CORBA::Boolean 
Zynq7035_PL_servant::allocateCapacity(
...
throw (
	...
	CORBA::SystemException)
{	
	DEBUG(5, [Zynq7035_PL_servant::allocateCapacity], " In allocateCapacity.")
...
/**************************OPENSCA-USERREGION-BEGIN*******************************/
	/// assume that one component will occupy whole FPGA resource, because FPGA just allow
	/// only one component run in the same chip
 ...
 */
void 
Zynq7035_PL_servant::deallocateCapacity(
	const CF::Properties & capacities)
throw (
	CF::Device::InvalidState, 
	CF::Device::InvalidCapacity, 
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::deallocateCapacity],
		" In deallocateCapacity.")
...
throw (
	...
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::configure], " In configure.")
	...
	try {
		...
		DEBUG(0, [Zynq7035_PL_servant::configure],
...
/**************************OPENSCA-USERREGION-BEGIN*******************************/
	/// only readwrite and writeonly can be configured. if this properties
	/// need to be saved after configured, call PropertySet_impl::configure(props);
 ...
 */
void 
Zynq7035_PL_servant::initialize()
throw (
	CF::LifeCycle::InitializeError, 
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::initialize], " In initialize.")
 ...
 */
char * 
Zynq7035_PL_servant::label() 
throw (
	CORBA::SystemException)
{
	DEBUG(9, [Zynq7035_PL_servant::label], " In label.")
...
Zynq7035_PL_servant::operationalState()
throw (
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::operationalState], "In operationalState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 */
void 
Zynq7035_PL_servant::query(
	CF::Properties & props)
throw (
	CF::UnknownProperties,
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::query], "In query.")
...
throw (
	...
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::runTest], " In runTest.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
 ...
 */
char * 
Zynq7035_PL_servant::softwareProfile() 
throw (
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::softwareProfile], " In softwareProfile.")
 ...
 */
void 
Zynq7035_PL_servant::start() 
throw (
	CF::Resource::StartError, 
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::start], " In start.")
 ...
 */
void 
Zynq7035_PL_servant::stop() 
throw (
	CF::Resource::StopError, 
	CORBA::SystemException)
{
	DEBUG(5, [Zynq7035_PL_servant::stop], " In stop.")
 ...
 */
CF::Device::UsageType 
Zynq7035_PL_servant::usageState() 
throw (
	CORBA::SystemException)
{
	DEBUG(9, [Zynq7035_PL_servant::usageState], " In usageState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 */
CORBA::Object_ptr 
Zynq7035_PL_servant::getPort(
	const char * portName)
throw (
	CORBA::SystemException, 
	CF::PortSupplier::UnknownPort)
{
    DEBUG(6, [Zynq7035_PL_servant::getPort], "In getPort.")
...
void 
Zynq7035_PL_servant::configureAD9371()
{
	std::string comp_naming = "OpenSCA_Domain/Single_Node/Device_Manager/AD9371";
	CORBA::Object_ptr obj = 
		m_orbWrap->get_object_from_string(comp_naming.c_str());
	if (CORBA::is_nil(obj)) {
		DEBUG(0, [Zynq7035_PL_servant::configureAD9371],
			" obtain obj failed.")
		return;
	}
	...
	const char * item)
{
	if (!configParser->getValueById(item)) {
		DEBUG(0, [checkConfigInfo], " can't find " << item)
		return "";
	}
	...
	CORBA::SystemException)
{
	...
	DEBUG(5, [Zynq7035_PL_servant::load], "In load.")
/**************************OPENSCA-USERREGION-BEGIN*******************************/
	char openScaPath[64];
	...
	std::string catPath = fsRoot + "/" + file;
	std::string cat = "cat ";
	std::string dev = " > /dev/xdevcfg";
	std::string command = cat + catPath + dev;
	DEBUG(3, [Zynq7035_PL_servant::load],
			" exec cat command:" << command)

	int result = system(command.c_str());
	if(-1 == result){
		DEBUG(0, [Zynq7035_PL_servant::load], " system error.")
	}
	configureAD9371();	
/**************************OPENSCA-USERREGION-END*********************************/
#endif
...
{
#ifdef __SDS_OS_LINUX__
	DEBUG(7, [Zynq7035_PL_servant::unload], "In unload." << fileName)
/**************************OPENSCA-USERREGION-BEGIN*******************************/
	char openScaPath[64];
	getConfigFilePathFromSHM(openScaPath, sizeof(openScaPath));
	ConfigParser configParser(openScaPath);
	std::string fsRoot = checkConfigInfo(&configParser, CONSTANT::FSROOT);
	if ("" == fsRoot) {
		DEBUG(0, [Zynq7035_PL_servant::unload], " fsRoot error.")
		return;
	}

	std::string sdrRoot = checkConfigInfo(&configParser, CONSTANT::SDRROOT);
	if ("" == sdrRoot) {
		DEBUG(0, [Zynq7035_PL_servant::unload], " sdrRoot error.")
		return;
	}

	std::string bitPath = fileName;
	size_t pos = bitPath.find_last_of("/");
    bitPath = bitPath.substr(0, pos + 1) + "BaseFunc.bit";
	DEBUG(3, [Zynq7035_PL_servant::unload],
		" bitPath:" << bitPath)

	std::string catPath = fsRoot + "/" + bitPath;
	DEBUG(3, [Zynq7035_PL_servant::unload],
			" catPath:" << catPath)
	...
	std::string dev = " > /dev/xdevcfg";
	std::string command = cat + catPath + dev;
	DEBUG(7, [Zynq7035_PL_servant::unload],
			" exec cat command: " << command)

	int result = system(command.c_str());
	if(-1 == result){
		DEBUG(0, Zynq7035_PL_servant, " system error.")
	}
/**************************OPENSCA-USERREGION-END*********************************/
#endif
}
 ...
 */
void 
Zynq7035_PL_servant::setUsageState(
	CF::Device::UsageType newUsageState)
{
	DEBUG(5, [Zynq7035_PL_servant::setUsageState], " In setUsageState.")
	pthread_mutex_lock(&m_stateMtx);
 ...
 */
void 
Zynq7035_PL_servant::setOperationalState(
	CF::Device::OperationalType newOperationalState)
{
	DEBUG(5, [Zynq7035_PL_servant::setOperationalState],

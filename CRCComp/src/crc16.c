...
{
	static const unsigned short crc16_table[256] = { 0x0000, 0x1189, 0x2312,
	...
	unsigned short crc16_reg = ~last_crc16;
	unsigned char * byte_data = (unsigned char*) data;
	int i;
	for (i = 0; i < data_length; i++)
	{
		crc16_reg = (crc16_reg >> 8)
				^ crc16_table[(crc16_reg ^ byte_data[i]) & 0xff];
	}
	return ~crc16_reg;
}
